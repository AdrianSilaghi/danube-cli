...
// parseSince/sanitize moved to lib/log-text so every product's diagnostics
// share one implementation. Re-exported because diagnose.ts and the tests
// import them from here.
import { parseSince, sanitize } from '../../lib/log-text.js';

// Re-exported because diagnose.ts and the tests import them from here.
export { parseSince, sanitize };
